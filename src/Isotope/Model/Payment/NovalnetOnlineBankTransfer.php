...
class NovalnetOnlineBankTransfer extends Postsale implements IsotopePayment
{
    /**
     * @var NovalnetHelper
     */
    ...
    */
    ...
    public function checkoutForm(IsotopeProductCollection $order, Module $module)
    {
        ...
        $data['transaction']['test_mode'] = !empty($this->novalnetonlinebanktransferTestMode) ? $this->novalnetonlinebanktransferTestMode : '0';
