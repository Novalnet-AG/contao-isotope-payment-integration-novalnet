...
\Isotope\Model\Payment::registerModelType('novalnetonlinebanktransfer', \NovalnetGateway\IsotopeNovalnetBundle\Isotope\Model\Payment\NovalnetOnlineBankTransfer::class);
\Isotope\Model\Payment::registerModelType('novalnettwint', \NovalnetGateway\IsotopeNovalnetBundle\Isotope\Model\Payment\NovalnetTwint::class);
