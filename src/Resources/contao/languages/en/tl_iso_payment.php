...
$GLOBALS['TL_LANG']['tl_iso_payment'] = array_merge($GLOBALS['TL_LANG']['tl_iso_payment'], [
    'novalnetglobalconfigActivationKey' => ['Product activation key', 'Enter the Novalnet Product activation key that is required for authentication. You will find the Product activation key in the Novalnet Admin Portal: Projects > Choose your project > API credentials > API Signature (Product activation key)'],
    ...
    'novalnetglobalconfigAccessKey' => ['Payment access key ', 'Enter the Novalnet Product activation key. To get the Product Activation Key, go to Novalnet admin portal: Projects > Choose your project > API credentials > API Signature (Product activation key)'],
    ...
    'novalnetglobalconfigEnableSendMail' => ['Notification / Webhook URL execution messages will be sent to this e-mail', 'Additional e-mails to which Webhook execution messages will be sent'],
    ...
    'novalnetglobalconfigPendingOrderStatus' => ['Pending order status', 'Status to be used for pending payments.'],
    'novalnetglobalconfigHoldOrderStatus' => ['On-hold order status', 'Status to be used for on-hold orders until the transaction is confirmed or canceled'],
    'novalnetglobalconfigCancelledOrderStatus' => ['Canceled order status', 'Status to be used when order is canceled or fully refunded'],
    ...
    'novalnetccEnforce3d' => ['Enforce 3D secure payment outside EU', 'By enabling this option, all payments from cards issued outside the EU will be authenticated via 3DS 2.0 SCA.'],
    ...
    'novalnetsepaDueDate' => ['Payment due date (in days)', 'Number of days after which the payment is debited (must be between 3 and 14 days)'],
    ...
    'novalnetonlinebanktransferTestMode' => ['Enable test mode', 'Enable this option to test payments at your checkout page. In the test mode the amount will not actually be charged by Novalnet. Remember to disable the test mode again after testing to ensure that actual purchased are properly charged'],

    'novalnettwintTestMode' => ['Enable test mode', 'Enable this option to test payments at your checkout page. In the test mode the amount will not actually be charged by Novalnet. Remember to disable the test mode again after testing to ensure that actual purchased are properly charged'],
