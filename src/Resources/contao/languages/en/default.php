...
$GLOBALS['TL_LANG']['MODEL']['tl_iso_payment']['novalnetonlinebanktransfer'] = ['Novalnet Online Bank Transfer'];
...
$GLOBALS['TL_LANG']['MSC']['nn_payment_qr_code_reference'] = 'Alternatively, you can use the QR code below for your convenience. Please scan it with your banking app to complete the payment.';
...
// Webhook
$GLOBALS['TL_LANG']['MSC']['nn_webhook_transaction_confirm'] = 'The transaction has been confirmed on %s.';
$GLOBALS['TL_LANG']['MSC']['nn_webhook_transaction_cancel'] = 'The transaction has been canceled on %s.';

$GLOBALS['TL_LANG']['MSC']['nn_webhook_transaction_pending_to_onhold'] = 'The transaction status has been changed from pending to on-hold for the TID: %s on %s.';

$GLOBALS['TL_LANG']['MSC']['nn_webhook_refund_parent_tid'] = 'Refund has been initiated for the TID: %s with the amount %s %s.';
$GLOBALS['TL_LANG']['MSC']['nn_webhook_refund_child_tid'] = 'Refund has been initiated for the TID: %s with the amount %s %s. New TID:%s for the refunded amount.';

$GLOBALS['TL_LANG']['MSC']['nn_webhook_transfer_amount'] = 'Please transfer the amount of %s %s on or before %s ';
$GLOBALS['TL_LANG']['MSC']['nn_webhook_transaction_update'] = 'Transaction updated successfully for the TID: %s with the amount %s on %s';
$GLOBALS['TL_LANG']['MSC']['nn_webhook_redirection_update'] = 'Transaction updated successfully for the TID: %s on %s';
