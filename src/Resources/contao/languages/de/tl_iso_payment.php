...
$GLOBALS['TL_LANG']['tl_iso_payment'] = array_merge($GLOBALS['TL_LANG']['tl_iso_payment'], [
    'novalnetglobalconfigActivationKey' => [' Produktaktivierungsschlüssel', 'Geben Sie den Novalnet-Produktaktivierungsschlüssel ein, der für die Authentifizierung erforderlich ist. Den Produktaktivierungsschlüssel finden Sie im Novalnet Admin-Portal: Projekte > Wählen Sie Ihr Projekt > API-Anmeldeinformationen > API Signature (Aktivierungsschlüssel des Produkts)'],
    ...
    'novalnetglobalconfigAccessKey' => ['Zahlungs-Zugriffsschlüssel', 'Novalnet-Aktivierungsschlüssel für das Produkt eingeben. Um diesen Aktivierungschlüssel für das Produkt zu erhalten, gehen Sie zum Novalnet-Admin-Portal - Projekte > Wählen Sie Ihr Projekt > API-Anmeldeinformationen > API Signature (Aktivierungsschlüssel des Produkts)'],
    ...
    'novalnetglobalconfigPendingOrderStatus' => ['Status der ausstehenden Bestellung', 'Status für offene Zahlungen'],
    'novalnetglobalconfigHoldOrderStatus' => ['On-hold-Bestellstatus', 'Wählen Sie, welcher Status für On-hold-Bestellungen verwendet wird, solange diese nicht bestätigt oder storniert worden sind'],
    'novalnetglobalconfigCancelledOrderStatus' => ['Status für stornierte Bestellungen', 'Wählen Sie, welcher Status für stornierte oder voll erstattete Bestellungen verwendet wird'],
    ...
    'novalnetccEnforce3d' => ['3D-Secure-Zahlungen außerhalb der EU erzwingen', 'Wenn Sie diese Option aktivieren, werden alle Zahlungen mit Karten, die außerhalb der EU ausgegeben wurden, mit der starken Kundenauthentifizierung (Strong Customer Authentication, SCA) von 3D-Secure 2.0 authentifiziert.'],
    ...
    'novalnetsepaDueDate' => ['Fälligkeitsdatum (in Tagen)', 'Geben Sie die Anzahl der Tage ein, nach denen der Zahlungsbetrag eingezogen werden soll (muss zwischen 3 und 14 Tagen liegen) '],
    ...
    'novalnetonlinebanktransferTestMode' => ['Testmodus aktivieren', 'Aktivieren Sie diese Option, um das Bezahlen auf Ihrer Checkout-Seite zu testen. Im Testmodus werden Zahlungen nicht von Novalnet ausgeführt. Vergessen Sie nicht, den Testmodus nach dem Testen wieder zu deaktivieren, um sicherzustellen, dass die echten Bestellungen ordnungsgemäß abgerechnet werden'],

    'novalnettwintTestMode' => ['Testmodus aktivieren', 'Aktivieren Sie diese Option, um das Bezahlen auf Ihrer Checkout-Seite zu testen. Im Testmodus werden Zahlungen nicht von Novalnet ausgeführt. Vergessen Sie nicht, den Testmodus nach dem Testen wieder zu deaktivieren, um sicherzustellen, dass die echten Bestellungen ordnungsgemäß abgerechnet werden'],
