...
$GLOBALS['TL_DCA']['tl_iso_payment']['fields'] = array_merge($GLOBALS['TL_DCA']['tl_iso_payment']['fields'], [
    'novalnetglobalconfigPendingOrderStatus' => [
        'label' => &$GLOBALS['TL_LANG']['tl_iso_payment']['novalnetglobalconfigPendingOrderStatus'],
        'exclude' => true,
        'inputType'  => 'select',
...
$GLOBALS['TL_DCA']['tl_iso_payment']['fields'] = array_merge($GLOBALS['TL_DCA']['tl_iso_payment']['fields'], [
    'novalnetglobalconfigHoldOrderStatus' => [
        'label' => &$GLOBALS['TL_LANG']['tl_iso_payment']['novalnetglobalconfigHoldOrderStatus'],
        'exclude' => true,
        'inputType'  => 'select',
        'foreignKey'  => \Isotope\Model\OrderStatus::getTable().'.name',
        'options_callback' => array('\Isotope\Backend', 'getOrderStatus'),
...
$GLOBALS['TL_DCA']['tl_iso_payment']['fields'] = array_merge($GLOBALS['TL_DCA']['tl_iso_payment']['fields'], [
    'novalnetglobalconfigCancelledOrderStatus' => [
        'label' => &$GLOBALS['TL_LANG']['tl_iso_payment']['novalnetglobalconfigCancelledOrderStatus'],
        'exclude' => true,
        'inputType'  => 'select',
        'foreignKey'  => \Isotope\Model\OrderStatus::getTable().'.name',
        'options_callback' => array('\Isotope\Backend', 'getOrderStatus'),
...
$GLOBALS['TL_DCA']['tl_iso_payment']['fields'] = array_merge($GLOBALS['TL_DCA']['tl_iso_payment']['fields'], [
    'novalnetccEnforce3d' => [
        'label' => &$GLOBALS['TL_LANG']['tl_iso_payment']['novalnetccEnforce3d'],
        'exclude' => true,
        'inputType' => 'checkbox',
        'eval' => ['mandatory' => false, 'maxlength' => 255, 'tl_class' => 'w50'],
        'sql' => "char(1) NULL default '0'",
...
$GLOBALS['TL_DCA']['tl_iso_payment']['fields'] = array_merge($GLOBALS['TL_DCA']['tl_iso_payment']['fields'], [
    'novalnetonlinebanktransferTestMode' => [
        'label' => &$GLOBALS['TL_LANG']['tl_iso_payment']['novalnetonlinebanktransferTestMode'],
        'exclude' => true,
        'inputType' => 'checkbox',
        'eval' => ['mandatory' => false, 'maxlength' => 255, 'tl_class' => 'w50'],
        'sql' => "char(1) NULL default '0'",
...
// TWINT
$GLOBALS['TL_DCA']['tl_iso_payment']['fields'] = array_merge($GLOBALS['TL_DCA']['tl_iso_payment']['fields'], [
    'novalnettwintTestMode' => [
        'label' => &$GLOBALS['TL_LANG']['tl_iso_payment']['novalnettwintTestMode'],
        'exclude' => true,
        'inputType' => 'checkbox',
        'eval' => ['mandatory' => false, 'maxlength' => 255, 'tl_class' => 'w50'],
        'sql' => "char(1) NULL default '0'",
...
$GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['novalnetonlinebanktransfer'] = $GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['cash'];
$GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['novalnettwint'] = $GLOBALS['TL_DCA']['tl_iso_payment']['palettes']['cash'];
...
\Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ...
    ->addField('novalnetglobalconfigPendingOrderStatus', 'gateway_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField('novalnetglobalconfigHoldOrderStatus', 'gateway_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->addField('novalnetglobalconfigCancelledOrderStatus', 'gateway_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
...
\Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ...
    ->addField('novalnetccEnforce3d', 'gateway_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
...
\Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ->addLegend('gateway_legend', 'price_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_BEFORE)
    ->addField('novalnetonlinebanktransferTestMode', 'gateway_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->applyToPalette('novalnetonlinebanktransfer', 'tl_iso_payment');

// Twint
\Contao\CoreBundle\DataContainer\PaletteManipulator::create()
    ->addLegend('gateway_legend', 'price_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_BEFORE)
    ->addField('novalnettwintTestMode', 'gateway_legend', \Contao\CoreBundle\DataContainer\PaletteManipulator::POSITION_APPEND)
    ->applyToPalette('novalnettwint', 'tl_iso_payment');
